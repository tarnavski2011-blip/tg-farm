export type PremiumProductCode =
  | "DIAMONDS_50"
  | "DIAMONDS_120"
  | "DIAMONDS_300"
  | "VIP_7D"
...
export const PREMIUM_PRODUCTS: Record<PremiumProductCode, PremiumProduct> = {
  DIAMONDS_50: {
    code: "DIAMONDS_50",
    title: "50 Diamonds",
...
export function getPremiumProduct(code: string) {
  return PREMIUM_PRODUCTS[code as PremiumProductCode] ?? null;
}
